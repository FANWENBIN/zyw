	...
	;(function($){
		...
		$.imgUploadPop = function(o){
			...
			$.alert({
				...
				init: function(){
				    var id = o.id || "default"; 
					swfobject.embedSWF("../statics/swf/uploadPop.swf?v2.0.3", "swfimgupload", 500, 500, "11.9.0", "", {"id": id, "root": o.root, "imgServer": imgUploadServer, "width": o.width, "height": o.height});
				},
				btnY: "确定",
				btnN: "取消",
